...
public class FileCache {
    private static final String EXTERNAL_CHACHE_DIR_NAME = "LazyList";
    ...
    private File getAppExternalStorageDirectory() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            appExtDir = new File(android.os.Environment.getExternalStorageDirectory(),EXTERNAL_CHACHE_DIR_NAME);
        }
